        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                String contact_no = sharedPreference.getString("OFF_PHONE_NO",
                        "");
                @SuppressLint("WrongThread") String otp_no = "" + otp_received.getText().toString().trim();
                @SuppressLint("WrongThread") String new_password = "" + new_pswd.getText().toString().trim();

                String otpflg = "N";

                if (otp_no.trim().equals(Settings.changepwdotpresp.trim())) {
                    otpflg = "Y";
                }
